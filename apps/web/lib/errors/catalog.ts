...
export const ERROR_CATALOG: ErrorCategory[] = [
  {
    ...
    description:
      'A new version of Trellis Academy was released while this page was open, so it briefly fell out of sync. Reloading will pick up the latest version.',
    matchers: {
      statuses: [],
      messageIncludes: [
  ...
  {
    kind: 'grading',
    title: 'The assignment grader ran into trouble',
    description:
      'The grading request was interrupted or returned an incomplete response. This can be temporary, so trying again often works.',
    matchers: {
      statuses: [],
      messageIncludes: [
        'during grading',
