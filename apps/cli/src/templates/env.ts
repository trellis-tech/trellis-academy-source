...
export function generateEnvFile(config: SetupConfig): string {
  ...
  // Release one is single-host. Guessing a registrable domain from the final
  // two labels breaks public-suffix domains such as example.co.uk.
  const topDomain = config.domain
