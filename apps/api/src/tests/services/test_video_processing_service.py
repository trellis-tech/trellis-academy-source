...
def _ffmpeg_has_libx264() -> bool:
    ...
    return probe.returncode == 0 and "libx264" in probe.stdout


_HAS_FFMPEG_LIBX264 = _ffmpeg_has_libx264()
...
@pytest.mark.skipif(
    not _HAS_FFMPEG_LIBX264,
    reason="ffmpeg with libx264 encoder not installed",
)
