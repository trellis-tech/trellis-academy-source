...
def _allow_playgrounds_feature():
    with patch(
        "src.routers.playgrounds.playgrounds_generator.enforce_playgrounds_feature_for_org",
...
class TestPlaygroundsRouter:
    ...
    async def test_playground_entitlement_denial_happens_before_credit_spend(
        ...
        playground = Playground(
            ...
            course_uuid=None,
            html_content="<div>seed</div>",
            playground_uuid="playground_no_entitlement",
            course_id=None,
            created_by=admin_user.id,
            creation_date="2024-01-01",
            update_date="2024-01-01",
        ...
        denial = HTTPException(status_code=403, detail="Playgrounds feature is disabled")
        with patch(
            "src.routers.playgrounds.playgrounds_generator.enforce_playgrounds_feature_for_org",
