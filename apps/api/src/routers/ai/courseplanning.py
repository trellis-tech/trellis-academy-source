...
def require_course_planning_session_owner(session, current_user) -> int:
    """Resolve the caller and hide planning sessions they do not own."""
    acting_user_id = resolve_acting_user_id(current_user)
    if session.user_id is None or session.user_id != acting_user_id:
...
async def iterate_course_planning_session(
    ...
    require_course_planning_session_owner(session, current_user)
