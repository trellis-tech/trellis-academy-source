...
async def _authorize_activity_generation(
    request: Request,
    activity_uuid: str,
    current_user: PublicUser,
    db_session: AsyncSession,
) -> int:
    """Resolve the activity and require course edit rights before paid work."""
    activity = (
...
async def api_generate_audio(
    ...
    org_id = await _authorize_activity_generation(
