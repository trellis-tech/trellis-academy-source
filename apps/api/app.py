...
#
#  Trellis Academy · learning platform · FastAPI entrypoint
#
#  Based on LearnHouse community source; see trellis/MODIFICATIONS.md.
...
from src.academy.events import academy_shutdown_app, academy_startup_app
...
# Lifecycle
app.add_event_handler("startup", academy_startup_app(app))
app.add_event_handler("shutdown", academy_shutdown_app(app))
...
@app.get("/")
async def root():
    return {"Message": "Welcome to Trellis Academy"}
