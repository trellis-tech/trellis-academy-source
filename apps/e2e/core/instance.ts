...
export const BASE_URL = process.env.E2E_BASE_URL || `http://${DOMAIN}:${PORT}`
...
/** Canonical Trellis app origin used by the real local SSO issuer. */
export const TRELLIS_URL = process.env.E2E_TRELLIS_URL || `http://${DOMAIN}:3001`
...
export const ADMIN_PASSWORD = requiredEnvironmentValue('E2E_ADMIN_PASSWORD')
...
export const SKIP_BOOT = process.env.E2E_SKIP_BOOT === '1' || Boolean(process.env.E2E_BASE_URL)
